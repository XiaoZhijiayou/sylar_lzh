...
static uint32_t EncondeZigzag32(const int32_t& v){
  if(v < 0){
...
/**
 * @brief 下面这些算是一种加解码的方式
 * */
static uint32_t EncondeZigzag64(const int64_t& v){
  if(v < 0){
...
void ByteArray::writeInt32 (int32_t value){
  writeUint32(EncondeZigzag32(value));
}
...
void ByteArray::writeInt64 (int64_t value){
  writeUint64(EncondeZigzag64(value));
}
